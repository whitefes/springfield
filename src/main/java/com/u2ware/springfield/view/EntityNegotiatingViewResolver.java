...
public class EntityNegotiatingViewResolver extends WebApplicationObjectSupport implements Ordered, ViewResolver{

	protected final Logger logger = LoggerFactory.getLogger(getClass());

	private Properties properties;
	private String[] locations;
	public List<EntityViewResolver> entityViewResolvers = new ArrayList<EntityViewResolver>();
	...
	public void setEntityViewResolvers(List<EntityViewResolver> entityViewResolvers) {
	...
	//
	///////////////////////////////////////
	public void addViewResolver(EntityViewResolver viewResolver){
		entityViewResolvers.add(viewResolver);
	}
	public void removeViewResolver(EntityViewResolver viewResolver){
		entityViewResolvers.remove(viewResolver);
	}
	public EntityViewResolver findViewResolver(String viewKey){
		for(EntityViewResolver r : entityViewResolvers){
	...
	public View resolveViewName(String orgViewName, Locale locale) throws Exception {
		...
		EntityViewResolver viewResolver = findViewResolver(viewKey);
