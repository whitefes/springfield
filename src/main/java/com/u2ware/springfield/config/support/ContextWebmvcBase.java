...
import com.u2ware.springfield.view.EntityNegotiatingViewResolver;
...
public class ContextWebmvcBase extends WebMvcConfigurerAdapter{
	...
	*/
	...
	@Bean
	public EntityViewResolver springfieldDownloadViewResolver()  throws Exception{
		EntityViewResolver bean = new EntityViewResolver(springfieldDownloadView());
	...
	@Bean
	public EntityViewResolver springfieldStreamViewResolver()  throws Exception{
		EntityViewResolver bean = new EntityViewResolver(springfieldStreamView());
	...
	@Bean
	public EntityViewResolver springfieldJsonViewResolver()  throws Exception{
		EntityViewResolver bean = new EntityViewResolver(springfieldJsonView());
	...
	@Bean
	public EntityViewResolver springfieldXmlViewResolver()  throws Exception{
		EntityViewResolver bean = new EntityViewResolver(springfieldXmlView());
	...
	@Bean
	public EntityViewResolver springfieldXlsViewResolver()  throws Exception{
		EntityViewResolver bean = new EntityViewResolver(springfieldXlsView());
	...
	@Bean
	public EntityViewResolver springfieldCsvViewResolver()  throws Exception{
		EntityViewResolver bean = new EntityViewResolver(springfieldCsvView());
	...
	@Bean
	public EntityViewResolver springfieldJstlViewResolver()  throws Exception{
		EntityViewResolver bean = new EntityViewResolver(springfieldJstlView());
	...
	@Bean
	public EntityViewResolver springfieldTilesViewResolver()  throws Exception{
		EntityViewResolver bean = new EntityViewResolver(springfieldTilesView());
		bean.setBaseExtensions("jsp");
	...
	@Bean
	public EntityViewResolver springfieldThymeleafViewResolver()  throws Exception{
		EntityViewResolver bean = new EntityViewResolver(springfieldThymeleafView());
	...
	@Bean
	public EntityNegotiatingViewResolver springfieldViewResolver() throws Exception{
		...
		EntityNegotiatingViewResolver bean = new EntityNegotiatingViewResolver();
